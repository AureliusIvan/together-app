...
export class Preloader extends Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('avatar', 'Characters/Human/IDLE/base_idle_strip9.png', {
      frameWidth: 64,  // Replace with the width of a single frame
      frameHeight: 64, // Replace with the height of a single frame
    });
    //  Preload spritesheets for running
    this.load.spritesheet('avatar-run', 'Characters/Human/RUN/base_run_strip8.png', {
      frameWidth: 64,  // Replace with the width of a single frame
      frameHeight: 64, // Replace with the height of a single frame
    });
